...
HD_PWD='C:/Users/alevb/Desktop/DAS/P2/P2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log counter_mod8.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source counter_mod8.tcl -notrace
