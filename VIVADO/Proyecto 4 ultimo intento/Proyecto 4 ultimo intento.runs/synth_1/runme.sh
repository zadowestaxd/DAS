...
HD_PWD='C:/Users/alevb/Desktop/DAS/VIVADO/Proyecto 4 ultimo intento/Proyecto 4 ultimo intento.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ascensor.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ascensor.tcl
