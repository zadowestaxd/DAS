...
HD_PWD='C:/Users/alevb/Desktop/DAS/VIVADO/Proyecto 4 ultimo intento/Proyecto 4 ultimo intento.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ascensor.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ascensor.tcl -notrace
