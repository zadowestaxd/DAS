...
HD_PWD='C:/Users/alevb/Desktop/DAS/VIVADO/Práctica final/Práctica final.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PRACTICAFINAL.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PRACTICAFINAL.tcl
