...
---- type estados_bola is (upright, upleft, downrighht, downleft);
--  type estados_barra is (left, right, stop);
--    signal estado_bola : estados_bola;
--    signal estado_barra : estados_barra;
...
if (hcnt>=500 and hcnt<690) then --397 498
    if (vcnt>=940 and vcnt<960) then
        r2_ouput<= '1';
        else
         r2_ouput<= '0';
    end if;
