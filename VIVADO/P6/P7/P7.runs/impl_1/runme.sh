...
HD_PWD='C:/Users/alevb/Desktop/DAS/VIVADO/P6/P7/P7.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log teclado.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source teclado.tcl -notrace
