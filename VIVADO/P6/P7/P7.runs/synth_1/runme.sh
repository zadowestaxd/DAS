...
HD_PWD='C:/Users/alevb/Desktop/DAS/VIVADO/P6/P7/P7.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log teclado.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source teclado.tcl
