...
HD_PWD='C:/Users/alevb/Desktop/DAS/P2/P2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log counter_mod8.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source counter_mod8.tcl
