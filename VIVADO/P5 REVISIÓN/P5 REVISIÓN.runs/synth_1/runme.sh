...
HD_PWD='C:/Users/alevb/Desktop/DAS/VIVADO/P5 REVISIÓN/P5 REVISIÓN.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log P5REVISION.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source P5REVISION.tcl
