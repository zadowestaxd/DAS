...
HD_PWD='C:/Users/alevb/Desktop/DAS/VIVADO/project_4/project_4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log my_RAM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source my_RAM.tcl
