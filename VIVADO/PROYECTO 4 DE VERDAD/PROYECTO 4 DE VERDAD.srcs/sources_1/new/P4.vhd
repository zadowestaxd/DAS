...
component divisor_frecuencia is
    ...
    signal estado_actual : estados := p0;
    signal clk_aux : std_logic;
    signal piso_destino : std_logic_vector(1 downto 0);
    signal piso_actual_int: std_logic_vector(1 downto 0) := "00";
    signal counter : std_logic_vector(26 downto 0);     

begin

divisor_aux : divisor_frecuencia port map(reset, clkFPGA, "101111101011110000100000000", clk_aux); --pormap
