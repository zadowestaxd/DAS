...
HD_PWD='C:/Users/alevb/Desktop/DAS/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log divisor_frecuencia.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source divisor_frecuencia.tcl
