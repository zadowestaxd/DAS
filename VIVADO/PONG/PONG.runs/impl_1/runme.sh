...
HD_PWD='C:/Users/alevb/Desktop/DAS/VIVADO/PONG/PONG.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log divisor_frecuencia.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source divisor_frecuencia.tcl -notrace
